...
- Step 2 の generator と Step 4 の critic に渡すプロンプトに、この原則の要点（特に「指1本で成立するか」「ゼロ人でも面白い→人がいると更に」「クリップ映え＋固有名」「個人スコープの地雷」）を必ず織り込む。
...
- `trends`: Step 1 の要約
- `design_principles`: Step 0 の原則の要点（指1本/ゼロ人でも面白い/クリップ映え＋固有名/個人スコープの地雷 等）
